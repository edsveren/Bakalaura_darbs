...
#     attack_type = "09_clear_format_attack"
#     totalTimeLapse = 0
...
#             clear_format_attack(word, docPath, stegoDocPath, wdFormatDocumentDefault)
...
if __name__ == "__main__":
    # main()
    logging_time.unified_attack("09_clear_format_attack", clear_format_attack, True)