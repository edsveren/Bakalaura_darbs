...
from scripts.stego_methods._4_stego_method_modify_RGB_color_ch import stego_message_extraction
...
def main(desired_file: str|None) -> None:
    unified_passive_attack_file.passive_attack("stego_method_4", stego_message_extraction_check, None, desired_file)
